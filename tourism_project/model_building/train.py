...
mlflow.set_tracking_uri("https://abrasive-mothproof-stopwatch.ngrok-free.dev")   # complete the code to set the MLflow tracking URI
mlflow.set_experiment("MLshow")     # complete the code to set the MLflow experiment name (same as the dev experimentation cell)
...
param_grid = {
    ...
    'xgbclassifier__reg_lambda': [1, 0.1, 0.01],          # L2 regularization strength. Higher values help reduce overfitting.
}
# Model pipeline
...
with mlflow.start_run():
    ...
    model_path = 'tourism_project/deployment/logistic_regression_model.joblib'   # Specify the local file path (inside tourism_project/deployment/) where the trained model should be saved.
